...
/*   Updated: 2020/07/27 16:15:13 by gbaud            ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(Form &f) {
	try {
		...
		std::cout << *this << " cant sign " << f << " because grade is too low" << std::endl;
	}
}
...
void Bureaucrat::executeForm(Form const &f) const {
	try {
		...
		std::cout << *this << " cant execute " << f << " because grade is too low or it isn't signed" << std::endl;
	}
}
