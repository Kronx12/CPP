...
/*   Updated: 2020/03/15 12:47:10 by gbaud            ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
	...
	sup.ninjaShoebox(*trUe);
	sup.vaulthunter_dot_exe(frag.getName());
	sup.meleeAttack(frag.getName());
	sup.rangedAttack(frag.getName());
